                  ...
                  <nav class="main-nav">
                    ...
                    <a href="index.php" class="logo">
                      ...
                      <ul class="nav">
                          ...
                          <li><a href="meetings.php" class="active">List Notaris</a></li>
                          <li><a href="kontak.php">Hubungi Kami</a></li> 
                          <li class="has-sub">
                              <a href="javascript:void(0)">Pages</a>
                              <ul class="sub-menu">
                                  <li><a href="meetings.php">Upcoming Meetings</a></li>
                                  <li><a href="detail-nott.php">Meeting Details</a></li>
                              </ul>
                          </li>
                      </ul>        
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  <a href="detail-nott.php"><img src="assets/images/single-meeting.jpg" alt=""></a>
                </div>
                <div class="down-content">
                  <a href="detail-nott.php"><h4>Notaris Jaya</h4></a>
            ...
            <div class="col-lg-12">
              <div class="main-button-red">
                <a href="kontak.php">Hubungi melalui WhatsApp</a>
              </div>
            </div>
          </div>
        </div>
