        ...
        <div class="row">
            ...
            <div class="card bg-light d-flex flex-fill">
                ...
                <div class="row">
                    ...
                    <p class="text-muted text-sm"><b>Spesialis: </b>Pengurusan Izin Usaha, Pembagian Harta, Pengesahan Dokumen</p>
            ...
            <div class="card bg-light d-flex flex-fill">
                ...
                <div class="row">
                    <div class="col-7">
                    <h2 class="lead"><b>Maria Gonzales</b></h2>
                    <p class="text-muted text-sm"><b>Spesialis: </b>Perjanjian Kerjasama, Sertifikat Tanah, Pembuatan Akta</p>
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Alamat: Demo Street 123, Demo City 04312, NJ</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Telepon: + 800 - 12 12 23 52</li>
                    </ul>
                ...
                <div class="text-right">
                    ...
                    <a href="detail-notaris" class="btn btn-sm btn-primary">
                    <i class="fas fa-user"></i> View Profile
                    </a>
                </div>
                </div>
            ...
            <div class="card bg-light d-flex flex-fill">
                ...
                <div class="row">
                    <div class="col-7">
                    <h2 class="lead"><b>Nicole Pearson</b></h2>
                    <p class="text-muted text-sm"><b>Spesialis: </b> Pengurusan Hak Milik, Pembiayaan Properti, Pengalihan Hak </p>
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Alamat: Demo Street 123, Demo City 04312, NJ</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Telepon: + 800 - 12 12 23 52</li>
                    </ul>
            ...
            <div class="card bg-light d-flex flex-fill">
                ...
                <div class="row">
                    <div class="col-7">
                    <h2 class="lead"><b>Nicole Pearson</b></h2>
                    <p class="text-muted text-sm"><b>Spesialis: </b> Akta Jual Beli Kendaraan, Perjanjian Sewa Menyewa, Surat Kuasa</p>
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Alamat: Demo Street 123, Demo City 04312, NJ</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Telepon: + 800 - 12 12 23 52</li>
                    </ul>
            ...
            <div class="card bg-light d-flex flex-fill">
                ...
                <div class="row">
                    <div class="col-7">
                    <h2 class="lead"><b>Nicole Pearson</b></h2>
                    <p class="text-muted text-sm"><b>Spesialisasi: </b>Pendirian Perusahaan, Jual Beli Properti, Warisan</p>
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Telepon: + 800 - 12 12 23 52</li>
                    </ul>
                    </div>
            ...
            <div class="card bg-light d-flex flex-fill">
                ...
                <div class="row">
                    <div class="col-7">
                    <h2 class="lead"><b>Nicole Pearson</b></h2>
                    <p class="text-muted text-sm"><b>Spesialis: </b>Pendirian Yayasan, Pengurusan Hibah, Legalitas Usaha</p>
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Alamat: Demo Street 123, Demo City 04312, NJ</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Telepon: + 800 - 12 12 23 52</li>
                    </ul>
            ...
            <div class="card bg-light d-flex flex-fill">
                ...
                <div class="row">
                    <div class="col-7">
                    <h2 class="lead"><b>Nicole Pearson</b></h2>
                    <p class="text-muted text-sm"><b>Spesialis: </b>Akta Kelahiran, Pernyataan Waris, Perjanjian Utang Piutang</p>
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Alamat: Demo Street 123, Demo City 04312, NJ</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Telepon: + 800 - 12 12 23 52</li>
                    </ul>
